...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('roles', [
      ...
      {
        id: getId('BusinessDevelopmentManager'),
      ...
      {
        id: getId('ClientRelationsSpecialist'),
...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('BusinessDevelopmentManager'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('ClientRelationsSpecialist'),
        permissionId: getId('CREATE_USERS'),
      },
